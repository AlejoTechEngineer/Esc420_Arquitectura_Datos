# ESC420 — Arquitectura de Datos · Unidad 4
### Arquitecturas Avanzadas de Almacenamiento — Bodega de Datos
...
| Archivo | Descripción |
|---------|-------------|
| `U4_BodegaDatos_ESC420.docx` | Desarrollo completo — Diseño de Bodega de Datos |
| `LF1_ESC420_U4.docx` / `.pdf` | Material de laboratorio formativo de la unidad |
| `U4_ActividadSumativa.docx` / `.pdf` | Guía y rúbrica de evaluación de la actividad |
